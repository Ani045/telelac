...
const ElectricHeaterBundlesPage = () => {
  ...
  const [mainImage, setMainImage] = useState("/electric-heater/6.png");
  ...
  return (
    <div className="min-h-screen bg-white">
          ...
          <div className="relative max-w-6xl max-h-full w-full">
            ...
            <div className="absolute bottom-4 left-4 right-4 bg-black/60 backdrop-blur-sm rounded-lg p-4 text-white">
              <div className="flex items-center justify-between">
                <div>
                  <h3 className="text-lg font-bold">Electric Heater Product Gallery</h3>
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-slate-600 text-lg">See our electric heater bundles in action</p>
            </div>
      ...
      <EnhancedQuoteForm
        ...
        productName="Electric Heater Bundles & Inline Process Heaters"
      />
    </div>
  );
};
