...
const MetalFinishingTanksPage = () => {
  ...
  const productImages = [
    ...
    },
    {
      ...
      title: "Installation",
      description: "Easy mounting system"
    },
    {
              ...
              <div className="relative">
                <div className="relative rounded-xl overflow-hidden shadow-2xl">
                  <img 
                    ...
                    onClick={() => setSelectedImage("https://images.unsplash.com/photo-1562813733-b31f71025d54?ixlib=rb-4.0.3&auto=format&fit=crop&w=1600&q=80")}
                  />
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 border border-slate-200">
              <p className="text-slate-700 text-lg leading-relaxed">
                Metal finishing tank heaters are specialized immersion heating solutions designed for electroplating, anodizing, and chemical processing applications. These heaters feature corrosion-resistant materials and coatings that can withstand aggressive chemical environments while providing precise temperature control. Our heaters are available with various protective coatings including Teflon, Quartz, and Titanium to ensure compatibility with specific chemical processes and extend service life in demanding applications.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-slate-600 text-lg">See our metal finishing tank heaters in detail</p>
            </div>
