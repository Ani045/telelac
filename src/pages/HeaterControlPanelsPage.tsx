...
const HeaterControlPanelsPage = () => {
  const [selectedImage, setSelectedImage] = useState<string | null>(null);

  const keyFeatures = [
    "Digital temperature control with PID algorithms",
    "Remote monitoring and SCADA integration",
    "Multiple safety interlocks and alarms",
    "Custom configuration for specific applications",
    "Touch screen HMI interface available",
  ...
  const specifications = [
    { label: "Control Type", value: "Digital PID" },
    { label: "Input Types", value: "RTD, Thermocouple" },
    { label: "Output", value: "Relay, SSR, 4-20mA" },
    { label: "Communication", value: "Modbus, Ethernet" },
    { label: "Protection", value: "IP65 rated" },
    { label: "Display", value: "Touch screen HMI" },
    { label: "Safety", value: "Multiple interlocks" },
    { label: "Power Supply", value: "24VDC, 230VAC" }
  ];
  ...
  const productImages = [
    {
      ...
      alt: "Heater Control Panel",
      title: "Main Control Panel",
      description: "Digital temperature control system"
    },
    {
    ...
    },
    {
      ...
      title: "Remote Access",
      description: "SCADA integration capabilities"
    },
    {
      ...
      title: "Installation",
      description: "Industrial control cabinet"
    },
    {
      ...
      description: "Professional wiring standards"
    }
  ];
        ...
        <div className="container mx-auto px-6 py-8">
          ...
          <nav className="mb-4">
            <div className="flex items-center space-x-2 text-sm text-slate-600">
              ...
              <ChevronRight className="w-4 h-4" />
              <span className="text-slate-900 font-medium">Heater Control Panels</span>
            </div>
          </nav>
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-3xl font-bold text-slate-900">Heater Control Panels</h1>
                <p className="text-slate-600">Advanced control systems for precise temperature management</p>
              </div>
            </div>
              ...
              <div className="relative">
                <div className="relative rounded-xl overflow-hidden shadow-2xl">
                  <img 
                    ...
                    onClick={() => setSelectedImage("https://images.unsplash.com/photo-1518709268805-4e9042af2176?ixlib=rb-4.0.3&auto=format&fit=crop&w=1600&q=80")}
                  />
                  ...
                  <div className="absolute bottom-6 left-6 right-6 grid grid-cols-3 gap-3">
                    <div className="bg-white/95 backdrop-blur-sm rounded-lg p-3 text-center">
                      <div className="text-2xl font-bold text-[#F0801C]">PID</div>
                      <div className="text-xs text-slate-700">Digital Control</div>
                    </div>
                    <div className="bg-white/95 backdrop-blur-sm rounded-lg p-3 text-center">
                    ...
                    <div className="bg-white/95 backdrop-blur-sm rounded-lg p-3 text-center">
                      <div className="text-2xl font-bold text-[#F0801C]">Remote</div>
                ...
                <div className="mt-6 bg-gradient-to-r from-[#F0801C] to-[#D6701A] text-white p-6 rounded-xl">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="text-lg font-bold mb-2">Smart Control Technology</h3>
                      <p className="text-sm text-white/90">
                        Telelec's heater control panels feature advanced PID algorithms, SCADA integration, and comprehensive safety systems for optimal performance and reliability in critical applications.
                      </p>
                    </div>
                  </div>
                </div>
                    ...
                    {specifications.slice(0, 4).map((spec, index) => (
                      <div key={index} className="p-5 text-center hover:bg-slate-50 transition-colors duration-200">
                        <div className="text-2xl font-bold text-[#F0801C] mb-1">
                          {spec.value.includes('Digital') ? 'PID' : 
                           spec.value.includes('RTD') ? 'Multi' : 
                           spec.value.includes('SSR') ? 'Multi' : 
                           spec.value.includes('Modbus') ? 'Digital' :
                           spec.value.split(' ')[0]}
                        </div>
                        <div className="text-xs font-semibold text-slate-900 mb-0.5">{spec.label}</div>
                        <div className="text-xs text-slate-600">
                          {spec.value.includes('Digital') ? 'Control algorithm' :
                           spec.value.includes('RTD') ? 'Input types' :
                           spec.value.includes('SSR') ? 'Output types' :
                           spec.value.includes('Modbus') ? 'Communication' :
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 border border-slate-200">
              <p className="text-slate-700 text-lg leading-relaxed">
                Telelec's heater control panels provide comprehensive temperature control and monitoring solutions for industrial heating systems. These advanced control systems feature digital PID controllers, touch screen HMI interfaces, and extensive communication capabilities. With built-in safety features, data logging, and remote monitoring capabilities, our control panels ensure precise temperature management while providing operators with real-time system status and historical data for optimal process control.
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              ...
              <div>
                ...
                <p className="text-slate-600 text-lg mb-8">
                  State-of-the-art control technology for precise temperature management and monitoring
                </p>
              ...
              <div>
                ...
                <div className="w-20 h-1 bg-[#F0801C] rounded-full mb-4"></div>
                <p className="text-slate-600 text-lg mb-8">
                  Versatile control solutions for diverse industrial automation needs
                </p>
                ...
                <div className="grid grid-cols-2 gap-4">
                  {applications.map((application, index) => (
                    <div key={index} className="p-4 bg-gradient-to-br from-orange-50 to-white rounded-xl border-2 border-orange-100 hover:border-orange-300 hover:shadow-lg transition-all duration-300 text-center group">
                      <Monitor className="w-8 h-8 text-[#F0801C] mx-auto mb-2 group-hover:scale-110 transition-transform duration-200" />
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-slate-600 text-lg">See our heater control panels and automation systems</p>
            </div>
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl lg:text-4xl font-bold mb-4">
              Need Advanced Control Solutions?
            </h2>
            <p className="text-xl mb-8 text-white/90">
              Get a custom quote for your heater control panel requirements
            </p>
...
export default HeaterControlPanelsPage;